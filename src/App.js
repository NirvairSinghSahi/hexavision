  ...
  return (
    <>
      ...
      <nav className="custom-navbar sticky-top">
        <a href="./index.html" className="nav-link">THE HOUSE</a>
        <a href="./meteHighJewelry.html" className="nav-link">HIGH JEWELRY</a>
        <a href="./KhantTiKyi.html" className="nav-link">ENGAGEMENT & BRIDAL</a>
        <a href="./AmirAlipour.html" className="nav-link">WATCHES</a>
        <a href="#" className="nav-link">ACCESSORIES</a>
        <a href="./LouFiles/Services(Lou).html" className="nav-link">SERVICES</a>
      </nav>
      ...
      <div id="sidebar" className="sidebar">
        ...
        <a href="./KhantTiKyi.html">ENGAGEMENT AND BRIDAL</a>
      ...
      <section className="house-section">
        <div className="image-container">
          <img
            src={`${process.env.PUBLIC_URL}/Nirvair_Singh_Sahi_Images/1-a3728410.png`}
            alt="The House of Harry Winston"
          />
        </div>
            ...
            <div className="footer-social">
              ...
              <div className="social-icons">
                <a href="https://www.facebook.com/story.php/?story_fbid=1670602513233142&id=1670578309902229&_rdr">
                  <img src={`${process.env.PUBLIC_URL}/Nirvair_Singh_Sahi_Images/facebook.png`} alt="Facebook" />
                </a>
                <a href="https://www.instagram.com/hexavision_enhancement/">
                  <img src={`${process.env.PUBLIC_URL}/Nirvair_Singh_Sahi_Images/instagram.png`} alt="Instagram" />
                </a>
                <a href="https://x.com/i/flow/login?redirect_after_login=%2Fhexacc">
                  <img src={`${process.env.PUBLIC_URL}/Nirvair_Singh_Sahi_Images/twitter.png`} alt="X" />
                </a>
                <a href="https://www.linkedin.com/company/joinhexa">
                  <img src={`${process.env.PUBLIC_URL}/Nirvair_Singh_Sahi_Images/linkedin.png`} alt="LinkedIn" />
                </a>
                <a href="https://www.youtube.com/channel/UC98o6FhZ1cfsNxGN3Cf_0bQ">
                  <img src={`${process.env.PUBLIC_URL}/Nirvair_Singh_Sahi_Images/youtube.png`} alt="YouTube" />
                </a>
              </div>
            </div>
          </div>
