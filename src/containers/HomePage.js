        ...
        <div className="divider-container">
          ...
          <div className="logo-container">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 28 43" fillRule="evenodd">
              <path d="M20.63 0H7.198L6.17.426.427 6.14 0 7.164v28.183l.427 1.023 5.744 5.716 1.027.424H20.68l1.026-.424 5.742-5.716.428-1.023V7.164L27.45 6.14 21.708.426 20.682 0h-.052z" />
            </svg>
          </div>
          <div className="divider-line"></div>
        </div>
