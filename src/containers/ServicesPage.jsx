    ...
    <>
      ...
      <section className="client-services-section">
        ...
        <div className="content-container">
          ...
          <p>
            A dedicated Hexa Vision Client Services expert looks forward to
            providing you with the ultimate personalized experience.
          </p>
        </div>
      </section>
      ...
      <div className="container">
        ...
        >
          <fieldset>
            ...
            <div className="form-group">
              <label htmlFor="country">Salon Country/Region</label>
            ...
            <div className="form-group">
              ...
              <select id="salon" name="salon" required>
                ...
                <option value="Toronto - Bloor Street">
                  Toronto - Bloor Street
                </option>
                <option value="New York - Fifth Avenue">
                  New York - Fifth Avenue
                </option>
                <option value="Paris - Rue Saint-Honoré">
                  Paris - Rue Saint-Honoré
                </option>
                <option value="Tokyo - Ginza">Tokyo - Ginza</option>
                <option value="Beijing - Wangfujing">
                  Beijing - Wangfujing
                </option>
              </select>
            </div>
            ...
            <p className="note">
              If you're unable to select certain dates, kindly contact the Hexa
              Vision Salon directly by phone. <a href="#">Find a Salon.</a>
            </p>
          </fieldset>
          ...
          <fieldset>
            ...
            <div className="form-group-inline">
              ...
              <label>
                <input type="radio" name="title" value="prefer-not-to-say" />{" "}
                Prefer not to say
              </label>
            </div>
            <div className="form-group">
            ...
            <div className="form-group-inline">
              <label>
                <input type="checkbox" name="contact-email" /> Email
              </label>
              <label>
                <input type="checkbox" name="contact-phone" /> Phone
              </label>
            </div>
          </fieldset>
          ...
          <fieldset>
            ...
            <div className="form-group">
              ...
              <select id="interest" name="interest" required>
                ...
                <option value="Engagement & Bridal">Engagement & Bridal</option>
            ...
            <div className="form-group-inline">
              <label>
                ...
                receive the newsletter (optional)
              </label>
            </div>
            <div className="form-group-inline">
              <label>
                <input type="checkbox" name="privacy" required /> I have read
                and accept the{" "}
        ...
        >
          <fieldset>
            ...
            <div className="form-group">
              <label htmlFor="details">
                Please provide more details (2000 characters max)
              </label>
              <textarea
                id="details"
                name="details"
          ...
          <fieldset>
            <legend>Personal Information</legend>
            <div className="form-group">
              <label htmlFor="first-name-assistance">First Name</label>
              <input
                type="text"
            ...
            <div className="form-group">
              <label htmlFor="last-name-assistance">Last Name</label>
              <input
                type="text"
            ...
            <div className="form-group">
              <label htmlFor="phone-assistance">Phone Number (Optional)</label>
              <input type="tel" id="phone-assistance" name="phone-assistance" />
            </div>
            <div className="form-group-inline">
              <label>
                <input type="checkbox" name="contact-email-assistance" /> Email
              </label>
              <label>
                <input type="checkbox" name="contact-phone-assistance" /> Phone
              </label>
            </div>
          </fieldset>
          ...
          <fieldset>
            <legend>Your Preferences</legend>
            <div className="form-group">
              <label htmlFor="country-assistance">Salon Country/Region</label>
              <select
            ...
            <div className="form-group">
              <label htmlFor="salon-assistance">Preferred Salon</label>
              <select id="salon-assistance" name="salon-assistance" required>
                <option value="">Select Salon</option>
                <option value="Toronto - Bloor Street">
                  Toronto - Bloor Street
                </option>
            ...
            <div className="form-group-inline">
              <label>
                <input type="checkbox" name="newsletter-assistance" /> I would
                like to receive the newsletter (optional)
              </label>
            </div>
            <div className="form-group-inline">
              <label>
                <input type="checkbox" name="privacy-assistance" required /> I
      ...
      <section className="unique-hexa-vision">
        <div className="container-unique">
          ...
          <div className="content-unique">
            <h1 className="unique-title">Find Nearest Hexa Vision</h1>
